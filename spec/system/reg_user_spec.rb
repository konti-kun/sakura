...
RSpec.describe 'エンドユーザの登録', type: :system do
  describe '正しい値を入れることでDBの' do
    before do
      ...
      fill_in 'user_end_user_attributes_nickname', with: 'さとー'
      attach_file 'user_end_user_attributes_image', "#{Rails.root}/spec/fixtures/images/sample1.png"
    end

    scenario 'Userデータが作成されている' do
      expect { click_button '登録' }.to(
